...
│   ├── data/
│   │   └── bone_xray.yaml             ← Dataset config, 15 class names
│   ├── train/
│   │   ├── fewshot_1shot.yaml
│   │   ├── fewshot_4shot.yaml
│   │   └── fewshot_8shot.yaml
...
│   │   │   └── llm_wrapper.py         ← LLMWrapper (Qwen disease desc gen)
│   │   ├── modules/
...
│   │   ├── bone_xray_dataset.py       ← BoneXRayDataset (RSNA dataset)
...
│   └── scripts/
│       ├── generate_llm_descriptions.py ← OFFLINE: generate disease descriptions
